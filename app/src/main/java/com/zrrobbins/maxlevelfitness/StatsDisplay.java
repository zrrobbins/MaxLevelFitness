 ...
 * {@link StatsDisplay.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link StatsDisplay#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StatsDisplay extends ListFragment {
    ...
    public static StatsDisplay newInstance(String param1, String param2) {
    ...
    public static StatsDisplay create(int pageNumber)
    {
        StatsDisplay fragment = new StatsDisplay();
        Bundle args = new Bundle();
    ...
    public void addItemToList(String newItemString) {
        listItems.add(newItemString);
